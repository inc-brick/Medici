...
type ArtArtistEvent struct {
	...
	EventNameJA string `json:"-" db:"EVENT_NAME_JA"`
	EventNameEN string `json:"-" db:"EVENT_NAME_EN"`
	EventDescriptionJA string `json:"-" db:"EVENT_DESCRIPTION_JA"`
	EventDescriptionEN string `json:"-" db:"EVENT_DESCRIPTION_EN"`
	EventImagePath string `json:"-" db:"EVENT_IMAGE_PATH"`
	EventStartAt time.Time `json:"event_start_at" db:"EVENT_START_AT"`
	EventEndAt time.Time `json:"event_end_at" db:"EVENT_END_AT"`
	EventPhone int `json:"-" db:"EVENT_PHONE"`
	EventMailAddress string `json:"-" db:"EVENT_MAIL_ADDRESS"`
	EventUrl string `json:"-" db:"EVENT_URL"`
}
